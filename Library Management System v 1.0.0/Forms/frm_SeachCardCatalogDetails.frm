...
Begin VB.Form frm_SeachCardCatalogDetails 
   BackColor       =   &H8000000E&
   BorderStyle     =   0  'None
   Caption         =   "shpDot"
   ClientHeight    =   6390
   ...
   Begin VB.ComboBox dc_Edition 
      Height          =   315
      ItemData        =   "frm_SeachCardCatalogDetails.frx":0000
      Left            =   1485
      List            =   "frm_SeachCardCatalogDetails.frx":001F
      Locked          =   -1  'True
      TabIndex        =   16
      Top             =   3645
      Width           =   1995
   ...
   Begin isCoolButton.isButton btn_Cancel 
      ...
      _ExtentX        =   2805
      _ExtentY        =   582
      Icon            =   "frm_SeachCardCatalogDetails.frx":0050
      Style           =   5
      Caption         =   "&Back"
      IconAlign       =   1
      iNonThemeStyle  =   0
   ...
   Begin VB.Image Image1 
      Height          =   720
      Left            =   270
      Picture         =   "frm_SeachCardCatalogDetails.frx":006C
      Top             =   360
      Width           =   720
   End
   ...
   End
End
Attribute VB_Name = "frm_SeachCardCatalogDetails"
...
Else
    frm_Main.StatusBar1.Panels(2).Text = "Active Form: View Card Catalog Details"
End If
End Sub
