...
Begin VB.Form frm_IndexDetails 
   BackColor       =   &H8000000E&
   BorderStyle     =   0  'None
   Caption         =   "shpDot"
   ClientHeight    =   6390
   ...
   Begin VB.ComboBox dc_Edition 
      Height          =   315
      ItemData        =   "frm_IndexDetails.frx":0000
      Left            =   1485
      List            =   "frm_IndexDetails.frx":001F
      TabIndex        =   15
      Top             =   4050
      Width           =   1995
   End
   ...
   Begin isCoolButton.isButton btn_Save 
      ...
      _ExtentX        =   2805
      _ExtentY        =   582
      Icon            =   "frm_IndexDetails.frx":0050
      Style           =   5
   ...
   Begin isCoolButton.isButton btn_Cancel 
      ...
      _ExtentX        =   2805
      _ExtentY        =   582
      Icon            =   "frm_IndexDetails.frx":006C
      Style           =   5
      Caption         =   "&Cancel"
      IconAlign       =   1
      iNonThemeStyle  =   0
   ...
   Begin VB.Image Image1 
      Height          =   720
      Left            =   315
      Picture         =   "frm_IndexDetails.frx":0088
      Top             =   360
      Width           =   720
   End
   ...
   End
End
Attribute VB_Name = "frm_IndexDetails"
...
With RS
    If ADD_STATE = True Then .AddNew
        ![IndexID] = txtEntry(0).Text
        ![Subject] = txtEntry(1).Text
        ![Title] = txtEntry(2).Text
        ![Author] = txtEntry(6).Text
        ![Publisher] = txtEntry(7).Text
        ![Edition] = dc_Edition.Text
        ![Page] = txtEntry(3).Text
        ![DateModified] = Now
    .Update
End With
...
Else
    frm_Main.StatusBar1.Panels(2).Text = "Active Form: Index Details - Edit Existing Record"
End If
End Sub
