...
Begin VB.Form frm_SearchRecords 
   ...
   ClientTop       =   435
   ClientWidth     =   7335
   Icon            =   "frm_SearchRecords.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin VB.ComboBox cbx_Type 
      Height          =   315
      ItemData        =   "frm_SearchRecords.frx":1982
      Left            =   945
      List            =   "frm_SearchRecords.frx":1984
   ...
   Begin isCoolButton.isButton btn_Search 
      ...
      _ExtentX        =   2090
      _ExtentY        =   582
      Icon            =   "frm_SearchRecords.frx":1986
      Style           =   5
      Caption         =   "&Search"
      IconAlign       =   1
      iNonThemeStyle  =   0
   ...
   Begin isCoolButton.isButton btn_Close 
      ...
      _ExtentX        =   2090
      _ExtentY        =   582
      Icon            =   "frm_SearchRecords.frx":19A2
      Style           =   5
      Caption         =   "&Cancel"
      IconAlign       =   1
      iNonThemeStyle  =   0
   ...
   Begin VB.Image Image1 
      Height          =   720
      Left            =   180
      Picture         =   "frm_SearchRecords.frx":19BE
      Top             =   90
      Width           =   720
   End
   ...
   End
End
Attribute VB_Name = "frm_SearchRecords"
...
Private Sub btn_Search_Click()
    ...
    RS.Requery
        ...
        Else
        If cbx_Type.Text = "Name" Then
        
            bFilter = "StudentName LIKE '%"
            
        Else
        If cbx_Type.Text = "User Name" Then
        
            bFilter = "FullName LIKE '%"
        
        Else
        If cbx_Type.Text = "User Type" Then
        
            bFilter = "UserType LIKE '%"
