...
Begin VB.Form frm_BooksRecord 
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.ComboBox cbx_Status 
         Height          =   315
         ItemData        =   "frm_BooksRecord.frx":0000
         Left            =   1575
         List            =   "frm_BooksRecord.frx":000D
      ...
      Begin VB.Image Image1 
         Height          =   240
         Left            =   90
         Picture         =   "frm_BooksRecord.frx":1E65
         Top             =   90
         Width           =   240
      End
   ...
   End
End
Attribute VB_Name = "frm_BooksRecord"
...
Dim RS_FindBookID As New ADODB.Recordset
...
Private Sub btn_Print_Click()
    ...
    CN15.Open "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & DB_LOCATION & ";Persist Security Info=False;Jet OLEDB:Database Password=admin"
    CN16.Open "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & DB_LOCATION & ";Persist Security Info=False;Jet OLEDB:Database Password=admin"
    ...
    ISSBN = lvList.SelectedItem.ListSubItems(8)
        ...
        RS_FindBookID.Open "SELECT BookID FROM tbl_Book WHERE RowIndex LIKE '" & BookID & "'", CN15, adOpenStatic, adLockOptimistic
        
    
        rpt_BookTransaction.Sections("Section2").Controls("lblBookID").Caption = RS_FindBookID.Fields("BookID")
    ...
    If cbx_Status.Text = "Barrowed" Then
        ...
        RS_rptListofStudentBarrowedBooks.Open "SELECT * FROM qry_BarrowedBooks WHERE tbl_Book.RowIndex LIKE '" & Selected & "' AND BookSource LIKE '" & "Circulation" & "' AND  StatusReturned =" & False & "", CN16, adOpenStatic, adLockOptimistic
    ...
    ElseIf cbx_Status.Text = "Returned" Then
        ...
        RS_rptListofStudentBarrowedBooks.Open "SELECT * FROM qry_BarrowedBooks WHERE tbl_Book.RowIndex LIKE '" & Selected & "' AND BookSource LIKE '" & "Circulation" & "' AND StatusReturned =" & True & "", CN16, adOpenStatic, adLockOptimistic
    ...
    ElseIf cbx_Status.Text = "View All" Then
        ...
        RS_rptListofStudentBarrowedBooks.Open "SELECT * FROM qry_BarrowedBooks WHERE tbl_Book.RowIndex LIKE '" & Selected & "' AND BookSource LIKE '" & "Circulation" & "'", CN16, adOpenStatic, adLockOptimistic
...
Private Sub cbx_Status_Click()
    ...
    If cbx_Status.Text = "Barrowed" Then
        ...
        RS_BarrowedBooks.Open "SELECT StudentNo,StudentName,DateBarrowed,DateReturned,BookSource,Fines FROM qry_BarrowedBooks WHERE tbl_Book.RowIndex LIKE '" & Selected & "' AND StatusReturned =" & False & " AND BookSource LIKE '" & "Circulation" & "'", CN, adOpenStatic, adLockOptimistic
    ...
    ElseIf cbx_Status.Text = "Returned" Then
        ...
        RS_BarrowedBooks.Open "SELECT StudentNo,StudentName,DateBarrowed,DateReturned,BookSource,Fines FROM qry_BarrowedBooks WHERE tbl_Book.RowIndex LIKE '" & Selected & "' AND StatusReturned =" & True & " AND BookSource LIKE '" & "Circulation" & "'", CN, adOpenStatic, adLockOptimistic
    ...
    ElseIf cbx_Status.Text = "View All" Then
        ...
        RS_BarrowedBooks.Open "SELECT StudentNo,StudentName,DateBarrowed,DateReturned,BookSource,Fines FROM qry_BarrowedBooks WHERE tbl_Book.RowIndex LIKE '" & Selected & "' AND BookSource LIKE '" & "Circulation" & "'", CN, adOpenStatic, adLockOptimistic
...
Private Sub Form_Activate()
    ...
    frm_Main.StatusBar1.Panels(2).Text = "Active Form: Books Record"
...
''Set the record set
Call connect_to_db
RS.Open "SELECT * FROM tbl_Book ORDER BY Title ASC", CN, adOpenStatic, adLockOptimistic
...
Call FillListView(lvList, RS, pos_start, pos_end, 16, 9, False, False)
Call TRACK_LIST
''Clear variables
pos_start = 0
pos_end = 0
