...
Begin VB.Form frm_SearchCardRecords 
   ...
   ClientTop       =   435
   ClientWidth     =   7335
   Icon            =   "frm_SearchCardRecords.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin VB.ComboBox cbx_Type 
      Height          =   315
      ItemData        =   "frm_SearchCardRecords.frx":1982
      Left            =   945
      List            =   "frm_SearchCardRecords.frx":199B
   ...
   Begin isCoolButton.isButton btn_Search 
      ...
      _ExtentX        =   2090
      _ExtentY        =   582
      Icon            =   "frm_SearchCardRecords.frx":19DE
      Style           =   5
      Caption         =   "&Search"
      IconAlign       =   1
      iNonThemeStyle  =   0
   ...
   Begin isCoolButton.isButton btn_Close 
      ...
      _ExtentX        =   2090
      _ExtentY        =   582
      Icon            =   "frm_SearchCardRecords.frx":19FA
      Style           =   5
      Caption         =   "&Cancel"
      IconAlign       =   1
      iNonThemeStyle  =   0
   ...
   Begin VB.Image Image1 
      Height          =   720
      Left            =   180
      Picture         =   "frm_SearchCardRecords.frx":1A16
      Top             =   90
      Width           =   720
   End
   ...
   End
End
Attribute VB_Name = "frm_SearchCardRecords"
...
Private Sub btn_Search_Click()
    ...
    RS.Requery
        ...
        Else
        If cbx_Type.Text = "Title Name" Then
