...
Begin VB.Form frm_ListOfStudentsIndexTransaction 
   ...
   Icon            =   "frm_ListOfStudentsIndexTransaction.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6075
   ...
   Begin VB.ComboBox cbx_Type 
      Height          =   315
      ItemData        =   "frm_ListOfStudentsIndexTransaction.frx":3482
      Left            =   1125
      List            =   "frm_ListOfStudentsIndexTransaction.frx":3492
      TabIndex        =   4
      Top             =   5490
      Width           =   1725
   End
   Begin isCoolButton.isButton btn_Select 
      ...
      _ExtentX        =   2090
      _ExtentY        =   582
      Icon            =   "frm_ListOfStudentsIndexTransaction.frx":34BF
      Style           =   5
      Caption         =   "&Select"
      IconAlign       =   1
      iNonThemeStyle  =   0
   ...
   Begin isCoolButton.isButton btn_Search 
      ...
      _ExtentX        =   2090
      _ExtentY        =   609
      Icon            =   "frm_ListOfStudentsIndexTransaction.frx":34DB
      Style           =   5
      Caption         =   "&Search"
      IconAlign       =   1
      iNonThemeStyle  =   0
   ...
   Begin isCoolButton.isButton btn_Close 
      ...
      _ExtentX        =   2090
      _ExtentY        =   582
      Icon            =   "frm_ListOfStudentsIndexTransaction.frx":34F7
      Style           =   5
      Caption         =   "&Close"
      IconAlign       =   1
      iNonThemeStyle  =   0
   ...
   Begin isCoolButton.isButton btn_Reload 
      ...
      _ExtentX        =   2090
      _ExtentY        =   582
      Icon            =   "frm_ListOfStudentsIndexTransaction.frx":3513
      Style           =   5
      Caption         =   "&Reload"
      IconAlign       =   1
      iNonThemeStyle  =   0
   ...
   Begin VB.Image Image1 
      Height          =   720
      Left            =   270
      Picture         =   "frm_ListOfStudentsIndexTransaction.frx":352F
      Top             =   180
      Width           =   720
   End
End
Attribute VB_Name = "frm_ListOfStudentsIndexTransaction"
...
Private Sub btn_Select_Click()
    ...
    SRC_RI = Val(lvList.SelectedItem.ListSubItems(10))
        ...
        If isIssueIndex = True Then
        
            frm_IssueIndex.txt_StudentNo = RS_SelectStudent.Fields("StudentNo")
            frm_IssueIndex.txt_StudentName = RS_SelectStudent.Fields("StudentName")
            
        Else
        
            frm_ReturnIndex.txt_StudentNo = RS_SelectStudent.Fields("StudentNo")
            frm_ReturnIndex.txt_StudentName = RS_SelectStudent.Fields("StudentName")
...
'    If isIssueIndex = True Then
        ...
        RS_Student.Open "SELECT * FROM tbl_Students WHERE IndexinHand >=" & 1 & "", CN2, adOpenStatic, adLockOptimistic
    
'    ElseIf isIssueIndex = False Then
'
