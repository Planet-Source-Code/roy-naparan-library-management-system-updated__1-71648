...
Begin VB.Form frm_CardCatalog 
   ...
   End
End
Attribute VB_Name = "frm_CardCatalog"
...
Private Sub Form_Activate()
    ...
    frm_Main.toolbar_Menu.Buttons(4).Value = tbrPressed

    frm_Main.StatusBar1.Panels(2).Text = "Active Form: Card Catalog"
...
lvList.Height = (Me.ScaleHeight - (Picture1.ScaleHeight + 30))
End Sub
...
''Set the record set
Call connect_to_db
RS.Open "SELECT * FROM tbl_Catalog ORDER BY CatalogID ASC", CN, adOpenStatic, adLockOptimistic
...
Call FillListView(lvList, RS, pos_start, pos_end, 10, 7, False, False)
Call TRACK_LIST
''Clear variables
pos_start = 0
pos_end = 0
...
Select Case SEL_COMMAND
    ...
    Case 5:
        ...
        frm_CardCatalogDetails.SRC_RI = Val(lvList.SelectedItem.ListSubItems(9))
        frm_CardCatalogDetails.ADD_STATE = False
        frm_CardCatalogDetails.Show
        Unload Me
End Select
End Sub
